...
from texGUI import Ui_TeX_Condensator as DI

class MyDialog(QtGui.QDialog, DI): 
	
	global ok, changed, entryText, authors, title, subtitle, institute, date, mail, keyWordPriority, numberOfSlides, charactersPerSlide, dirName
	changed = ok = False
	dirName = ""
	...
	def __init__(self): 
		...
		self.setupUi(self)
		self.setWindowTitle("TeX(t)-Condensator")
	...
	def onOK(self):
		global ok, entryText, authors, title, subtitle, institute, date, mail, keyWordPriority, numberOfSlides, 			charactersPerSlide
		ok = True
